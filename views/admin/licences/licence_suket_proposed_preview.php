  ...
  <div class="content">
    <div class="row">
      ...
      <div class="col-md-6 no-padding licence-preview-template">
        <?php $this->load->view('admin/licences/licence_proposed_preview_template'); ?>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 no-padding licence-table-related">
        <?php
            $this->load->view('admin/licences/licence_table_suket_proposed');
         ?>
      </div>
    </div>
    </div>
...
<script>
    $(function(){
        initDataTable('.table-suket-proposed', admin_url+'licences/table_suket_proposed', 'undefined', 'undefined','fnServerParams', [0, 'desc']);
    });
</script>
...
Editable(".editable", {
  onEnd(ev, UI) { // ev=Event UI=Editable this=HTMLElement
    ...
    const data = {
      licence_id: this.dataset.licence_id,
