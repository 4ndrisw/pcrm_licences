   ...
   <div class="table-responsive s_table">
      <table class="table licence-items-table items table-main-licence-edit has-calculations no-mtop">
         <thead>
            <tr>
               <th></th>
               <th width="30%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('licence_table_item_heading'); ?></th>
               <th width="45%" align="left"><?php echo _l('licence_table_item_description'); ?></th>
               <?php
            ...
            <tr class="main">
               ...
               <td>
                  <?php
                     ...
                     ?>
                  <button type="button" onclick="add_licence_item_to_table('undefined','undefined',<?php echo $new_item; ?>); return false;" class="btn text-center btn-info"><i class="fa fa-check"></i></button>
               </td>
            </tr>
