				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							$selected = array();
							$contacts = $this->clients_model->get_contacts($licence->clientid,array('active'=>1,'project_emails'=>1));
							...
							echo render_select('sent_to[]',$contacts,array('id','email','firstname,lastname'),'licence_sent_to_email',$selected,array('multiple'=>true),array(),'','',false);
							?>
						</div>
