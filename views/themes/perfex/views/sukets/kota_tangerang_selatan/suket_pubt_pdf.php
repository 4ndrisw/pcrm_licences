...
$jenis_bejana = isset($equipment['jenis_bejana']) ? $equipment['jenis_bejana'] : '';
...
$text .= ' maka telah dilakukan Pemeriksaan dan Pengujian terhadap Bejana Tekanan. Adapun data umum dan data teknis yang menjadi objek Bejana Tekanan diterangkan adalah sebagai berikut :';
$text .= '</div>';
...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">1. Jenis Bejana Tekan / Penggunaan</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_nama_pesawat / $equipment_digunakan_untuk</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">2. Bentuk Bejana Tekanq</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$jenis_bejana</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">5. Tekanan Kerja</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_tekanan_kerja</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">6. Volume</td>
        <td style="width:10;">:</td>
