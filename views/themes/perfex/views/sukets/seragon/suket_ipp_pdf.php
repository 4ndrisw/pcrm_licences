...
$equipment_pembumian = isset($equipment['pembumian']) ? $equipment['pembumian'] : '';
...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">1. Jenis Penyalur Petir</td>
        <td style="width:10;">:</td>
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">3. Material Down Conductor</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_penghantar</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">4. Jumlah Tiang Penerima</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_penerima</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">5. Jumlah Pentanahan</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_pembumian</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">6. Tinggi Bangunan</td>
        <td style="width:10;">:</td>
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">3. Pengujian Grounding</td>
        <td style="width:10;">:</td>
        <td style="width:220;">Baik</td>
        <td style="width:200;">(Terlampir)</td>
    </tr>
