...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">1. Merek / Model Engine</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_merk_engine / $equipment_type_model_engine</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">&nbsp;&nbsp;&nbsp;&nbsp;Merk / Model Generator</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_merk_generator / $equipment_type_model_generator</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">2. Pabrik Pembuat engine</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_pabrik_pembuat_engine</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">&nbsp;&nbsp;&nbsp;&nbsp;Pabrik Pembuat Generator</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_pabrik_pembuat_generator</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">4. Nomor Seri Engine</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_nomor_seri_engine</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">&nbsp;&nbsp;&nbsp;&nbsp;Nomor Seri Generator</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_nomor_seri_generator</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
