...
$equipment_pabrik_pembuat_hoist = isset($equipment['pabrik_pembuat_hoist']) ? $equipment['pabrik_pembuat_hoist'] : '';
...
$equipment_pabrik_pembuat_hoist = isset($equipment['pabrik_pembuat_hoist']) ? $equipment['pabrik_pembuat_hoist'] : '';
$equipment_pabrik_pembuat_rangka = isset($equipment['pabrik_pembuat_rangka']) ? $equipment['pabrik_pembuat_rangka'] : '';
...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">1.Pabrik Pembuat Hoist</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_pabrik_pembuat_hoist</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">2. Pabrik Pembuat Rangka</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_pabrik_pembuat_rangka</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">4. Nomor Seri / Nomor Item</td>
        <td style="width:10;">:</td>
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">2. Pengujian NDT</td>
        <td style="width:10;">:</td>
        <td style="width:220;">Baik</td>
        <td style="width:200;">(Terlampir)</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">3. Pengujian Beban</td>
        <td style="width:10;">:</td>
        <td style="width:220;">Baik</td>
        <td style="width:200;">(Terlampir)</td>
    </tr>
