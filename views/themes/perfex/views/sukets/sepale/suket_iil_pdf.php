...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">1. Sumber Tenaga</td>
        <td style="width:10;">:</td>
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">3. Untuk Penerangan</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_daya_penerangan</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">4. Untuk Tenaga</td>
        <td style="width:10;">:</td>
        <td style="width:370;">$equipment_daya_tenaga</td>
    </tr>
    <tr>
        <td style="width:20;"></td>
        <td style="width:310;">5. Jenis Arus</td>
        <td style="width:10;">:</td>
    ...
    <tr>
        <td style="width:20;"></td>
        <td style="width:650;">Berdasarkan hasil pemeriksaan dan pengujian tersebut $equipment_nama_pesawat</td>
        <td style="width:5;"></td>
        <td style="width:5;"></td>
    </tr>
</table>
