...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        ...
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">Tangki Penampung</td>
    </tr>
    <tr>
...
$pdf->write2DBarcode($qrcode, 'QRCODE,M', $x_pos+70, $y_pos+11, 40, 40, $style, 'N');
...
$pdf->MultiCell(0, 0, $assigned, 0, 'R', 0, 1, $x_pos+100, $y_pos+7, true, 0, true);
