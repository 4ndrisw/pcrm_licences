...
$equipment_kekuatan_motor =$equipment['kekuatan_motor'];
$equipment_kapasitas =$equipment['kapasitas'];
$equipment_kecepatan =$equipment['kecepatan'];
...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="width:200;">Kekuatan Motor Penggerak</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_kekuatan_motor</td>
    </tr>
    <tr>
        <td style="width:200;">Kecepatan</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_kecepatan</td>
    </tr>
    <tr>
