...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="border-bottom:1px solid black; width:200;">Nomor Seri</td>
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">$equipment_nomor_seri</td>
    </tr>
    <tr>
        <td style="border-bottom:1px solid black; width:200;">Nomor Unit</td>
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">$equipment_nomor_unit</td>
    </tr>
    <tr>
        <td style="border-bottom:1px solid black; width:200;">Kecepatan Angkat</td>
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">$equipment_kecepatan_angkat</td>
    </tr>
    <tr>
