...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="width:200;">Pabrik Pembuat Hoist</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_pabrik_pembuat_hoist</td>
    </tr>
    <tr>
        <td style="width:200;">Pabrik Pembuat Rangka</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_pabrik_pembuat_rangka</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="width:200;">No Unit</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_nomor_unit</td>
    </tr>
    <tr>
        <td style="width:200;">Kapasitas Angkat</td>
        <td style="width:45;">:</td>
