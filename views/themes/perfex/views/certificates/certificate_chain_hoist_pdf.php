...
$equipment_pabrik_pembuat_hoist = $equipment['pabrik_pembuat_hoist'];
$equipment_pabrik_pembuat_rangka = isset($equipment['pabrik_pembuat_rangka']) ? $equipment['pabrik_pembuat_rangka'] : 'CEK DATA INSPEKSI';
...
$certificate_proposed_raw = isset($certificate->proposed_date) ? _d($certificate->proposed_date) : '1970-01-01';
...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="border-bottom:1px solid black; width:200;">Pabrik Pembuat Hoist</td>
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">$equipment_pabrik_pembuat_hoist</td>
    </tr>
    <tr>
        <td style="border-bottom:1px solid black; width:200;">Pabrik Pembuat Rangka</td>
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">$equipment_pabrik_pembuat_rangka</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="border-bottom:1px solid black; width:200;">No Seri</td>
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">$equipment_nomor_seri</td>
    </tr>
    <tr>
