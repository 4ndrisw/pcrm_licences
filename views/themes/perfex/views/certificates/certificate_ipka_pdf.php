...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="width:200;">Jumlah Alarm Bell</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jumlah_alarm_bell</td>
    </tr>
    <tr>
        <td style="width:200;">Jumlah Smoke Detector</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jumlah_smoke_detector</td>
    </tr>
    <tr>
        <td style="width:200;">Jumlah Heat Detector</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jumlah_heat_detector</td>
    </tr>
    <tr>
        <td style="width:200;">Jumlah Titik Panggil</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jumlah_titik_manggil_manual</td>
    </tr>
    <tr>
        <td style="width:200;">Jumlah Alarm Lampu</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jumlah_alarm_lamp</td>
    </tr>
    <tr>
