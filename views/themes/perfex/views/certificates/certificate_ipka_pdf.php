...
$equipment_jumlah_alarm_lamp = isset($equipment['jumlah_alarm_lamp']) ? $equipment['jumlah_alarm_lamp'] : 'CEK DATA INSPEKSI';
...
$equipment_jumlah_alarm_bell = isset($equipment['jumlah_alarm_bell']) ? $equipment['jumlah_alarm_bell'] : 'CEK DATA INSPEKSI';
$equipment_jumlah_smoke_detector = isset($equipment['jumlah_smoke_detector']) ? $equipment['jumlah_smoke_detector'] : 'CEK DATA INSPEKSI';
$equipment_jumlah_heat_detector = isset($equipment['jumlah_heat_detector']) ? $equipment['jumlah_heat_detector'] : 'CEK DATA INSPEKSI';
$equipment_jumlah_titik_manggil_manual = isset($equipment['jumlah_titik_manggil_manual']) ? $equipment['jumlah_titik_manggil_manual'] : 'CEK DATA INSPEKSI';
...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="border-bottom:1px solid black; width:200;">Jumlah Alarm Bell</td>
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">$equipment_jumlah_alarm_bell</td>
    </tr>
    <tr>
        <td style="border-bottom:1px solid black; width:200;">Jumlah Smoke Detector</td>
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">$equipment_jumlah_smoke_detector</td>
    </tr>
    <tr>
        <td style="border-bottom:1px solid black; width:200;">Jumlah Heat Detector</td>
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">$equipment_jumlah_heat_detector</td>
    </tr>
    <tr>
        <td style="border-bottom:1px solid black; width:200;">Jumlah Titik Panggil</td>
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">$equipment_jumlah_titik_manggil_manual</td>
    </tr>
    <tr>
        <td style="border-bottom:1px solid black; width:200;">Jumlah Alarm Lampu</td>
        <td style="border-bottom:1px solid black; width:45;">:</td>
        <td style="border-bottom:1px solid black; width:400;">$equipment_jumlah_alarm_lamp</td>
    </tr>
    <tr>
