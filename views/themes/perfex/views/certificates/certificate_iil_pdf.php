...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="width:200;">Jenis Arus</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jenis_arus</td>
    </tr>
    <tr>
        <td style="width:200;">Jenis Tegangan</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jenis_tegangan</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="width:200;">Daya Penerangan</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_daya_penerangan</td>
    </tr>
    <tr>
        <td style="width:200;">Daya Tenaga</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_daya_tenaga</td>
    </tr>
    <tr>
        <td style="width:200;">Daya Terpasang</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_daya_terpasang</td>
    </tr>
    <tr>
        <td style="width:200;">Sumber Tenaga</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_sumber_tenaga</td>
    </tr>
    <tr>
