...
<table cellspacing="1" cellpadding="1" border="0">
    ...
    <tr>
        <td style="width:200;">Tekanan Pompa</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_tekanan_pompa</td>
    </tr>
    <tr>
        <td style="width:200;">Jumlah Kotak Hydrant</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jumlah_kotak_hydrant</td>
    </tr>
    <tr>
        <td style="width:200;">Jumlah Selang Hydrant</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jumlah_selang_hydrant</td>
    </tr>
    <tr>
        <td style="width:200;">Jumlah Pilar Hydrant</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jumlah_pilar_hydrant</td>
    </tr>
    <tr>
        <td style="width:200;">Jumlah Jokey Pump</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jumlah_jokey_pump</td>
    </tr>
    <tr>
        <td style="width:200;">Jumlah Elektrik Pump</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jumlah_elektrik_pump</td>
    </tr>
    <tr>
        <td style="width:200;">Jumlah Diesel Pump</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_jumlah_diesel_pump</td>
    </tr>
    <tr>
        <td style="width:200;">Kapasitas Air</td>
        <td style="width:45;">:</td>
        <td style="width:400;">$equipment_kapasitas_air</td>
    </tr>
    <tr>
